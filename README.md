# MeteorTodoiOS
This is simple boiletplate to show how to use SwiftDDP to connect with meteor server.

Connect your native iOS apps, written in Swift, to apps built with the [Meteor](https://www.meteor.com/) framework and build real-time features.

And this boilerplate shows the implementation of [SwiftDDP](https://github.com/siegesmund/SwiftDDP)

This is a extended version of another [example] (https://github.com/siegesmund/SwiftDDP/tree/master/Examples/Dictionary) 

It shows both way of using collection like MeteorDocument and AbstractCollection.
...
- [Meteor Todos with dictionary AbstractCollection based in-memory storage](https://github.com/Sadmansamee/MeteorTodoiOS)
